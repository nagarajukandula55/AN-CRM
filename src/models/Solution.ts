 ...
 * business-specific solution with other businesses. Also optionally
 * vendorId-scoped, same as FaultCode/SymptomCode, so a vendor can
 * self-manage their own solution list.
 */
...
SolutionSchema.index({ businessId: 1, vendorId: 1, code: 1 }, { unique: true });
