...
export const EMAIL_OCCASIONS: EmailOccasion[] = [
  ...
  { key: "VENDOR_APPROVED", label: "Vendor Approved", description: "A vendor application was approved.", tokens: ["vendorName", "vendorId", "businessName", "loginUrl"] },
  { key: "VENDOR_REJECTED", label: "Vendor Rejected", description: "A vendor application was rejected.", tokens: ["vendorName", "vendorId", "businessName", "reason"] },
