  ...
  if (error || !job) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-3">
        ...
        <button onClick={() => router.push('/console/crm/jobsheets')} className="text-sm text-gray-500 underline">Back to Workorders</button>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <div className="px-6 py-10">
        <div className="flex items-center gap-4 mb-6">
          <button onClick={() => router.push('/console/crm/jobsheets')} className="w-9 h-9 rounded-xl border border-gray-200 bg-white flex items-center justify-center hover:bg-gray-100 transition">
          ...
          <div className="ml-auto flex gap-2">
            ...
            {job.invoiceId && (
              <button
                onClick={() => router.push(`/console/crm/invoices/${job.invoiceId}`)}
