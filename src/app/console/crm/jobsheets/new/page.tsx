      ...
      <div className="max-w-[1800px] mx-auto px-6 py-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-3">
            <button type="button" onClick={() => router.push('/console/crm/jobsheets')} className="flex-1 px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-sm text-gray-500 hover:text-gray-900 transition">
              Cancel
            </button>
            <button
              type="submit"
