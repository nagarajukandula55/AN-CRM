    ...
    <div className="min-h-screen bg-bg text-ink">
      <div className="px-6 py-10">
        <PageHeader
          ...
          actions={<Button variant="secondary" size="sm" onClick={() => router.push('/console')} icon={<ArrowLeft className="w-4 h-4" />}>Back</Button>}
        />
