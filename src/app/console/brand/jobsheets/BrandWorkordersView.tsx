      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Button onClick={() => router.push('/console/brand/jobsheets/new')} icon={<Plus className="w-4 h-4" />}>New Job Sheet</Button>
          </>
        }
      />
        ...
        <table className="w-full text-sm min-w-[960px]">
          ...
          <tbody className="divide-y divide-border">
            {jobSheets.length === 0 ? (
              ...
              jobSheets.map((js) => (
                <tr key={js._id} className="hover:bg-surface-2 transition-colors cursor-pointer" onClick={() => router.push(`/console/brand/jobsheets/${js._id}`)}>
