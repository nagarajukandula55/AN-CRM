  ...
  return (
    <div className="min-h-screen bg-bg text-ink p-6">
      <PageHeader
        ...
        actions={<Button variant="secondary" onClick={() => router.push('/console/brand/jobsheets')} icon={<ArrowLeft className="w-4 h-4" />}>Back</Button>}
      />
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl">
        ...
        <div className="flex gap-3">
          <Button type="button" variant="secondary" size="lg" className="flex-1" onClick={() => router.push('/console/brand/jobsheets')}>
            Cancel
          </Button>
          <Button
            type="submit"
