...
export default function PageColumnsPanel() {
    ...
    <>
      ...
      <div className="flex items-start justify-between gap-4 mb-6">
        <p className="text-sm text-ink-3 max-w-2xl">
          Control which columns and dashboard cards vendor pages show, their order, and their label text.
        </p>
        <Button onClick={handleSave} disabled={saving || loading} loading={saving} icon={<Save className="w-4 h-4" />}>Save</Button>
      </div>
