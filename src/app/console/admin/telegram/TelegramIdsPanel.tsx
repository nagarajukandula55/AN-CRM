...
export default function TelegramIdsPanel() {
  ...
  return (
    <>
      <p className="text-sm text-ink-3 max-w-2xl mb-6">
        Every vendor's Group/Personal Telegram chat ID in one place -- edit directly here, same effect as that vendor sending /link themselves.
      </p>
