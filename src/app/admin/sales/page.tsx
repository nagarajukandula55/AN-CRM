    ...
    <div className="min-h-screen bg-bg p-6">
      <div>
        ...
        <PageHeader
          ...
          actions={
            <>
              <Button variant="secondary" size="sm" onClick={() => router.push('/admin')} icon={<ArrowLeft size={15} />}>Back</Button>
              <Button onClick={() => setShowForm(true)} icon={<Plus size={15} />}>New Invoice</Button>
            </>
          }
        />
